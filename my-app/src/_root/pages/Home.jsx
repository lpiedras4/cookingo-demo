        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="mt-3 h-3 overflow-hidden rounded-full border-2 border-green-200 bg-green-50">
              <div
                className="h-full rounded-full bg-gradient-to-r from-forest to-amber transition-all duration-500"
          ...
          <div className="hidden md:flex gap-2">
            <div className="rounded-xl border-2 border-stone-200 bg-stone-50 px-4 py-3 text-center">
              ...
              <p className="text-xs font-bold uppercase tracking-wide text-stone-400">XP Total</p>
            </div>
            <div className="rounded-xl border-2 border-stone-200 bg-stone-50 px-4 py-3 text-center">
              <p className="font-display text-xl font-bold text-orange">{completedLessons.length}</p>
              <p className="text-xs font-bold uppercase tracking-wide text-stone-400">Recetas</p>
            </div>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div className="mt-4 flex items-center justify-between text-sm">
                  <div className="flex items-center gap-1">
                    <span className="font-bold text-amber">✨ {lesson.totalXp} XP</span>
                  </div>
